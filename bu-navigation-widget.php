...
class BU_Widget_Pages extends WP_Widget {
	...
	function BU_Widget_Pages() {
		$widget_ops = array( 'classname' => 'widget_bu_pages', 'description' => __( "Navigation list of your site's pages", BU_Navigation_Plugin::TEXT_DOMAIN ) );
		$this->WP_Widget( 'bu_pages', __('Content Navigation', BU_Navigation_Plugin::TEXT_DOMAIN ), $widget_ops );
	}
